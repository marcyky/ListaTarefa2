...
import {
  ...
  NgForm,
  Validators
} from "./chunk-GZSHZG5O.js";
import {
  MatButton,
  MatButtonModule,
  MatIconButton
} from "./chunk-OIWBTY35.js";
import {
  MAT_FORM_FIELD,
  MatFormFieldControl
} from "./chunk-Q57ZRAWY.js";
import {
  animate,
  keyframes,
  state,
...
var MatDateSelectionModel = class _MatDateSelectionModel {
  constructor(selection, _adapter) {
    ...
    this._selectionChanged = new import_rxjs4.Subject();
...
var MatMonthView = class _MatMonthView {
  ...
  constructor(_changeDetectorRef, _dateFormats, _dateAdapter, _dir, _rangeStrategy) {
    ...
    this._rerenderSubscription = import_rxjs4.Subscription.EMPTY;
...
var MatCalendar = class _MatCalendar {
  ...
  constructor(_intl, _dateAdapter, _dateFormats, _changeDetectorRef) {
    ...
    this.stateChanges = new import_rxjs4.Subject();
    if (typeof ngDevMode === "undefined" || ngDevMode) {
      if (!this._dateAdapter) {
        throw createMissingDateImplError("DateAdapter");
      }
...
var MatDatepickerContent = class _MatDatepickerContent {
  constructor(_elementRef, _changeDetectorRef, _globalModel, _dateAdapter, _rangeSelectionStrategy, intl) {
    ...
    this._subscriptions = new import_rxjs4.Subscription();
...
var MatDatepickerBase = class _MatDatepickerBase {
  ...
  constructor(_overlay, _unusedNgZone, _viewContainerRef, scrollStrategy, _dateAdapter, _dir, _model) {
    ...
    this._dir = _dir;
    this._model = _model;
    this._inputStateChanges = import_rxjs4.Subscription.EMPTY;
  ...
  _getCloseStream(overlayRef) {
    ...
    return (0, import_rxjs4.merge)(overlayRef.backdropClick(), overlayRef.detachments(), overlayRef.keydownEvents().pipe((0, import_operators3.filter)((event) => {
...
var MatDatepickerInputBase = class _MatDatepickerInputBase {
  ...
  constructor(_elementRef, _dateAdapter, _dateFormats) {
    ...
    this._valueChangesSubscription = import_rxjs4.Subscription.EMPTY;
    this._localeSubscription = import_rxjs4.Subscription.EMPTY;
  ...
  _matchesFilter(value) {
    const filter4 = this._getDateFilter();
    return !filter4 || filter4(value);
  }
  static {
...
var MatDatepickerInput = class _MatDatepickerInput extends MatDatepickerInputBase {
  ...
  constructor(elementRef, dateAdapter, dateFormats, _formField) {
    ...
    this._closedSubscription = import_rxjs4.Subscription.EMPTY;
    this._openedSubscription = import_rxjs4.Subscription.EMPTY;
...
var MatDatepickerToggle = class _MatDatepickerToggle {
  ...
  constructor(_intl, _changeDetectorRef, defaultTabIndex) {
    this._intl = _intl;
    this._changeDetectorRef = _changeDetectorRef;
    this._stateChanges = import_rxjs4.Subscription.EMPTY;
  ...
  _watchStateChanges() {
    const datepickerStateChanged = this.datepicker ? this.datepicker.stateChanges : (0, import_rxjs4.of)();
    const inputStateChanged = this.datepicker && this.datepicker.datepickerInput ? this.datepicker.datepickerInput.stateChanges : (0, import_rxjs4.of)();
    const datepickerToggled = this.datepicker ? (0, import_rxjs4.merge)(this.datepicker.openedStream, this.datepicker.closedStream) : (0, import_rxjs4.of)();
    this._stateChanges.unsubscribe();
    this._stateChanges = (0, import_rxjs4.merge)(this._intl.changes, datepickerStateChanged, inputStateChanged, datepickerToggled).subscribe(() => this._changeDetectorRef.markForCheck());
  }
  static {
...
var MatDateRangeInput = class _MatDateRangeInput {
  ...
  ngAfterContentInit() {
    ...
    (0, import_rxjs4.merge)(this._startInput.stateChanges, this._endInput.stateChanges).subscribe(() => {
      this.stateChanges.next(void 0);
    });
  }
  ngOnChanges(changes) {
